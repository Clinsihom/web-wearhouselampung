...
<head>
	...
	<style>
		/* Additional CSS to change header color */
		header {
...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="index.php" style="color: #fff;">Barera Dealer Shop</a></h1>
			<ul>
				<li><a href="produk.php" style="color: #fff;">Semua Produk</a></li>
				<li><a href="" style="color: #fff;"> | </a></li>
				<li><a href="login.php" style="color: #fff;">Login Sebagai Admin</a></li>
			</ul>
		</div>
	</header>
